...
exports.executeSql=function(sql,connector){
    var promise=new Promise();
    Orm.connect(connector, function(err, db) {
        if(err) {
            throw err;
...
exports.generateModels=function(tableNames,connector){
    var map=tableNames.split(',').map(function(e){
        return e.split('=>');
    })
    Orm.connect(connector, function(err, db) {
        var promises=[];
        map.forEach(function(e){
            promises.push(createModel(e[0],e[1],db));
        })
...
function createModel(tableName,filename,db){
    var promise=new Promise();
